...
function CategoriesBtn({ imgAddress, categoryName, to }) {
  return (
    ...
    >
      <div
        className="relative flex items-center justify-center rounded-[2rem] bg-gray-50 border border-gray-100 shadow-sm p-4 md:p-6 transition-all duration-300 group-hover:bg-blue-50 group-hover:border-blue-200 group-hover:shadow-md group-hover:-translate-y-1"
        style={{
